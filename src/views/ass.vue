      ...
      <tbody>
        <tr v-for="asset in paginatedAssets" :key="asset.asset_id">
          ...
          <td class="text-center">
            <img
              v-if="asset.image"
              :src="'http://localhost:8081/homework/api_php/uploads/' + asset.image"
              width="80"
              class="rounded"
              alt="รูปครุภัณฑ์"
            />
            ...
            <div>
              ...
              <div class="mb-3">
                ...
                <div v-if="isEditMode && editForm.image">
                  ...
                  <img
                    :src="'http://localhost:8081/homework/api_php/uploads/' + editForm.image"
                    width="100"
                    class="rounded"
                    alt="รูปครุภัณฑ์เดิม"
                  />
...
export default {
  ...
  setup() {
    ...
    const fetchAssets = async () => {
      try {
        const res = await fetch("http://localhost:8081/homework/api_php/api_asset.php");
